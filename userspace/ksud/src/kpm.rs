    ...
    P: AsRef<Path>,
{
    ...
    let mut cmd = ksu_uapi::ksu_kpm_cmd {
        control_code: u64::from(ksu_uapi::KPM_LOAD),
...
pub fn list() -> Result<()> {
    ...
    let mut ret = -1;
    let mut cmd = ksu_uapi::ksu_kpm_cmd {
        control_code: u64::from(ksu_uapi::KPM_LIST),
...
pub fn unload_module(name: String) -> Result<()> {
    ...
    let mut ret = -1;
    let mut cmd = ksu_uapi::ksu_kpm_cmd {
        control_code: u64::from(ksu_uapi::KPM_UNLOAD),
...
pub fn info(name: String) -> Result<()> {
    ...
    let mut ret = -1;
    let mut cmd = ksu_uapi::ksu_kpm_cmd {
        control_code: u64::from(ksu_uapi::KPM_INFO),
        arg1: name.as_ptr() as u64,
...
pub fn control(name: String, args: String) -> Result<i32> {
    ...
    let mut ret = -1;
    let mut cmd = ksu_uapi::ksu_kpm_cmd {
        control_code: u64::from(ksu_uapi::KPM_CONTROL),
        arg1: name.as_ptr() as u64,
        arg2: args.as_ptr() as u64,
        result_code: &raw mut ret as u64,
    };
...
pub fn num() -> Result<i32> {
    let mut ret = -1;
    let mut cmd = ksu_uapi::ksu_kpm_cmd {
        control_code: u64::from(ksu_uapi::KPM_NUM),
        arg1: 0,
        arg2: 0,
        result_code: &raw mut ret as u64,
    };
...
pub fn version() -> Result<()> {
    ...
    let mut ret = -1;
    let mut cmd = ksu_uapi::ksu_kpm_cmd {
        control_code: u64::from(ksu_uapi::KPM_VERSION),
        arg1: buf.as_mut_ptr() as u64,
        arg2: buf.len() as u64,
        result_code: &raw mut ret as u64,
    };
